 ...
 */
final class Version20191204140301 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE inscription (id INT AUTO_INCREMENT NOT NULL, status INT NOT NULL, internal_procedure VARCHAR(255) NOT NULL, medical_certificate VARCHAR(255) NOT NULL, inscription_sheet VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, inscription_year VARCHAR(12) NOT NULL, image_right TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
